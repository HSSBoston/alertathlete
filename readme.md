...
HRIs affect thousands of athletes every year. There have been at least 77 HRI deaths among athletes in the US since 2000, and 65 of them (84%) are teenagers. Younger generations are more vulnerable due to their high metabolism. HRIs are the top cause of preventable deaths for high school athletes. This is a major public health and humanity issue. 

This work, called AlertAthlete, proposes a method to estimate a heat alert level from a set of meteorological parameters readily available for athletes and coaches. It employs machine learning (ML) in compliance with a major heat safety policy. The proposed ML method is implemetned in a Web application (https://wbgt-estimator.streamlit.app/) and a handy, wearable device to continuously track the current alert level during an athletic activity and issue early warnings for precautions and activity adjustment.
